...
function UserConfirmModal({heading,text,buttonConfigs,mainIcon}) {
  return (
    <div className="fixed inset-0 flex justify-center items-center bg-[#0000006b]">
      <div className="max-w-[30%] bg-white p-6 rounded-lg">
